...
| `local-suite` | 964 passed, 0 failed, 0 errored, 21 skipped | OBSERVED | local run, this machine, 2026-09-09 | a local result; the surfaces CI proves are in MANIFEST | not published |
