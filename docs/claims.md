...
the README's benchmark block was typed.
...
| `ci-head-attestation` | No complete CI run has attested the current `HEAD` | NOT_PROVEN | MANIFEST `source_commit` `5b477a9` ≠ `HEAD` | external billing capacity; no badge, and no green-CI claim | README, `support.md` |
